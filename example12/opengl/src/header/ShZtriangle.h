#ifndef _SHZTRIANGLE_H
#define _SHZTRIANGLE_H
...
class triangle :public ShZdrawManager, public ShZanimationManager, public ShZtimeManager, public ShZclearManager
{
public:
	triangle();
	~triangle();

#ifndef _SHZMULTIGONALSTAR_H
#define _SHZMULTIGONALSTAR_H
...
class multigonalStar :public ShZdrawManager, public ShZanimationManager, public ShZtimeManager, public ShZclearManager
{
public:
	multigonalStar();
	~multigonalStar();
	...
	void getAngles(GLdouble &angles);
	void setAngles(GLdouble angles);

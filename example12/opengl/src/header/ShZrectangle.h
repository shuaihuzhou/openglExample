#ifndef _SHZRECTANGLE_H
#define _SHZRECTANGLE_H
...
class rectangle :public ShZdrawManager, public ShZanimationManager, public ShZtimeManager, public ShZclearManager
{
public:
	rectangle();
	~rectangle();

...
#ifndef _ShZDEFINE_H_
#define _ShZDEFINE_H_
...
extern void ShZCheckGLError_(const char *file, int line);
extern ShZImage *ShZLoadTexture(const std::string &filename);
extern void modelLoadingDone();*/

/*
#ifdef _DEBUG
#define ShZCheckGLError()	ShZCheckGLError_(__FILE__, __LINE__)
#else
#define ShZCheckGLError()
#endif*/

...
void circle::getPosition(GLdouble &positionX, GLdouble &positionY, GLdouble &positionZ)
{
...
void circle::setPosition(GLdouble positionX, GLdouble positionY, GLdouble positionZ)
{
...
void circle::getR(GLdouble &r)
{
	r = this->m_R;
}

void circle::setR(GLdouble r)
{
	this->m_R = r;
}

void circle::getTypeName(string &p)
{
	p = m_typeName;
}

void circle::setTypeName(const char* p)
{
	m_typeName = p;
}

void circle::setTotalTime(double totalTime)
{
...
void circle::draw_shape(ShZshader *pShader)
{
	pShader->begin();
	glBindVertexArray(m_vao);
	drawface(pShader);
...
void circle::unfoldface()
{
	cout<<"sorry circle can't be unfolded"<<endl;
}

void circle::foldface()
{
	cout<<"sorry circle can't be folded"<<endl;
}


void circle::drawface(ShZshader *pShader)
{
	GLuint ebo1;
	glGenBuffers(1,&ebo1);

...
public:
	ShZMat4()
	{	LoadIdentity();	}
	ShZMat4(	float e0, float e1, float e2, float e3,
				float e4, float e5, float e6, float e7,
				float e8, float e9, float e10, float e11,
				float e12, float e13, float e14, float e15);
	ShZMat4(const float * rhs);
	ShZMat4(const ShZMat4 & rhs);
	~ShZMat4() {}	//empty
	...
	//binary operators
	ShZMat4 operator+(const ShZMat4 & rhs) const;
	ShZMat4 operator-(const ShZMat4 & rhs) const;
	ShZMat4 operator*(const ShZMat4 & rhs) const;
	ShZMat4 operator*(const float rhs) const;
	ShZMat4 operator/(const float rhs) const;
	friend ShZMat4 operator*(float scaleFactor, const ShZMat4 & rhs);

	bool operator==(const ShZMat4 & rhs) const;
	bool operator!=(const ShZMat4 & rhs) const;

	//self-add etc
	void operator+=(const ShZMat4 & rhs);
	void operator-=(const ShZMat4 & rhs);
	void operator*=(const ShZMat4 & rhs);
	void operator*=(const float rhs);
	void operator/=(const float rhs);
	...
	//unary operators
	ShZMat4 operator-(void) const;
	ShZMat4 operator+(void) const {return (*this);}
	...
	//Other methods
	void Invert(void);
	ShZMat4 GetInverse(void) const;
	void Transpose(void);
	ShZMat4 GetTranspose(void) const;
	void InvertTranspose(void);
	ShZMat4 GetInverseTranspose(void) const;

	//Inverse of a rotation/translation only matrix
	void AffineInvert(void);
	ShZMat4 GetAffineInverse(void) const;
	void AffineInvertTranspose(void);
	ShZMat4 GetAffineInverseTranspose(void) const;
